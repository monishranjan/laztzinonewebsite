...
! function(n, t, e) {
    ...
    function w(n, t, e) {
        return n = o(n), n[t] = (n[t] || []).map(function(n) {
            return x(n)
        }), a(e(n))
    }
    ...
    function P(n, t) {
        return R(n) ? new k.LatLngBounds({
            lat: n[2],
            lng: n[3]
        }, {
            lat: n[0],
            lng: n[1]
        }) : t && !n.getCenter ? new k.LatLngBounds({
            lat: n.south,
            lng: n.west
        }, {
            lat: n.north,
    ...
    function C(n, t) {
        ...
        function u() {
            ...
            p = "" + d, d > 3 && (a = e(), h(w, function(n, t) {
                ...
                }), s = u.join("-"), y[s] = !0, E[s] || (f = u.map(function(n) {
                    return w[n]
                }), c = t.cb(r(f)), c ? (a = l("LatLngBounds"), h(f, function(n) {
                    a.extend(n.getPosition()), n.getMap() && n.setMap(null)
                }), c = o(c), c.position = a.getCenter(), E[s] = new B(L, r(f), b(n, c), a), x.push(E[s])) : h(f, function(t) {
                    t.getMap() || t.setMap(n)
                })))
            }), h(v(E), function(n) {
                y[n] || (E[n].overlay.setMap(null), delete E[n])
            }), x.length && h(T, function(n) {
                n(x)
            }))
        }
        ...
        function g(n) {
            return function() {
                ...
                return P = P.then(function(e) {
                    return A(t[0]) ? S(t[0].call(c(), e)).then(function(e) {
    ...
    (function() {
        ...
        return n.holdReady(!0), s(function() {
            ...
            }, o = e.createElement("script"), o.type = "text/javascript", o.src = "https://maps.googleapis.com/maps/api/js?callback=" + i + (D ? "&" + ("string" == typeof D ? D : f(D)) : ""), n("head").append(o))
        }), r.promise()
    })().then(function() {
        n.holdReady(!1)
    }), n.gmap3 = function(n) {
